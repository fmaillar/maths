...
Lorsque $\alpha \geq 0$, les fonctions $f_\alpha$ peuvent se prolonger en zéro pour obtenir une fonction continue. Deux cas se présentent~:
\begin{itemize}
...
\begin{gather}
  \cos^2 x+\sin^2 x=1;\\
  \sin \left(\frac{\pi}{2}+x\right)= \sin \left(\frac{\pi}{2}-x\right)=\cos x; \\
